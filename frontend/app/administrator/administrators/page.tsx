...
export default function App() {
  ...
  const [administrators, setAdministrators] = useState<AdministratorType[]>([]);
  ...
  const renderCell = React.useCallback(
    (user: AdministratorType, columnKey: React.Key) => {
      const cellValue = user[columnKey as keyof AdministratorType];
              ...
              <Dropdown>
                ...
                <DropdownMenu>
                  <DropdownItem
                    onClick={() =>
                      router.replace(
                        `/administrator/administratorInformation/${user.id}`
                      )
                    }
                  >
                    View
